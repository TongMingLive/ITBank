 ...
 */
@WebServlet(name = "DeleteFuserServlet",urlPatterns = "/DeleteFuserServlet")
public class DeleteFuserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int r = dao.deleteFuser(userId,fuserId);
        if (r>0){
            out.print("true");
        }else {
            out.print("false");
