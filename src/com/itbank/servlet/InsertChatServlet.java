 ...
 */
@WebServlet(name = "InsertChatServlet",urlPatterns = "/InsertChatServlet")
public class InsertChatServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String chatPage = request.getParameter("chatPage");

        ChatDao dao = new ChatDao();
        int r = dao.insertChat(userId,cuserId,chatPage);
        if (r>0){
            out.print("true");
        }else {
            out.print("false");
